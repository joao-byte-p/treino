  ...
  <form class="form" data-settings>
    ...
    <section class="card">
      ...
      ` : `
        ...
        <label class="field"><span>O teu email</span><input type="email" inputmode="email" autocomplete="email" placeholder="treino@exemplo.pt" value="${esc(p.syncEmail || '')}" data-sync-email></label>
        <div class="actions-row">
