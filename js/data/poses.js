    ...
    frames: [
      {
        ...
        arms: [{ a: [-58, 42], far: true }, { a: [-124, -168] }],
        legs: [{ a: [-112, 176], foot: -80, far: true }, { a: [-70.8, -89.7], foot: 5 }],
      },
      {
        label: 'Apoio: anca por cima do pé',
        hip: [50, 55], torso: 84, head: 4,
        arms: [{ a: [-67.7, 11.2], far: true }, { a: [-114.3, -137.2] }],
        legs: [{ a: [-78, 150], foot: -110, far: true }, { a: [-66.4, -113.6], foot: 0 }],
      },
      {
        label: 'Impulso: a perna estende-se atrás',
        hip: [50, 51], torso: 84, head: 4,
        arms: [{ a: [-91, -63], far: true }, { a: [-91, -63] }],
        legs: [{ a: [-44, 34], foot: 130, far: true }, { a: [-101.2, -103.8], foot: -19 }],
      },
      {
        label: 'O pé larga o chão',
        hip: [50, 49], torso: 84, head: 4,
        arms: [{ a: [-114.3, -137.2], far: true }, { a: [-67.7, 11.2] }],
        legs: [{ a: [-34, -78], foot: 20, far: true }, { a: [-126, -170], foot: -60 }],
      },
      {
        label: 'Contacto do outro pé',
        hip: [50, 53], torso: 84, head: 4,
        arms: [{ a: [-124, -168], far: true }, { a: [-58, 42] }],
        legs: [{ a: [-70.8, -89.7], foot: 5, far: true }, { a: [-112, 176], foot: -80 }],
      },
      {
        label: 'Apoio do outro lado',
        hip: [50, 55], torso: 84, head: 4,
        arms: [{ a: [-114.3, -137.2], far: true }, { a: [-67.7, 11.2] }],
        legs: [{ a: [-66.4, -113.6], foot: 0, far: true }, { a: [-78, 150], foot: -110 }],
      },
      {
        label: 'Impulso do outro lado',
        hip: [50, 51], torso: 84, head: 4,
        arms: [{ a: [-91, -63], far: true }, { a: [-91, -63] }],
        legs: [{ a: [-101.2, -103.8], foot: -19, far: true }, { a: [-44, 34], foot: 130 }],
      },
      {
        label: 'E o outro pé larga o chão',
        hip: [50, 49], torso: 84, head: 4,
        arms: [{ a: [-67.7, 11.2], far: true }, { a: [-114.3, -137.2] }],
        legs: [{ a: [-126, -170], foot: -60, far: true }, { a: [-34, -78], foot: 20 }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        arms: [{ a: [-58, 42], far: true }, { a: [-124, -168] }],
        legs: [{ a: [-114, 172], foot: -84, far: true }, { a: [-77.6, -80.3], foot: 2 }],
      },
      {
        label: 'Apoio: anca por cima do pé',
        hip: [50, 54], torso: 80, head: 6,
        arms: [{ a: [-67.7, 11.2], far: true }, { a: [-114.3, -137.2] }],
        legs: [{ a: [-72, 142], foot: -114, far: true }, { a: [-70.8, -109.2], foot: 0 }],
      },
      {
        label: 'Impulso: a perna estende-se atrás',
        hip: [50, 50], torso: 80, head: 6,
        arms: [{ a: [-91, -63], far: true }, { a: [-91, -63] }],
        legs: [{ a: [-38, 26], foot: 126, far: true }, { a: [-104.2, -106.8], foot: -22 }],
      },
      {
        label: 'O pé larga o chão',
        hip: [50, 47], torso: 80, head: 6,
        arms: [{ a: [-114.3, -137.2], far: true }, { a: [-67.7, 11.2] }],
        legs: [{ a: [-28, -74], foot: 16, far: true }, { a: [-130, -174], foot: -64 }],
      },
      {
        label: 'Contacto do outro pé',
        hip: [50, 52], torso: 80, head: 6,
        arms: [{ a: [-124, -168], far: true }, { a: [-58, 42] }],
        legs: [{ a: [-77.6, -80.3], foot: 2, far: true }, { a: [-114, 172], foot: -84 }],
      },
      {
        label: 'Apoio do outro lado',
        hip: [50, 54], torso: 80, head: 6,
        arms: [{ a: [-114.3, -137.2], far: true }, { a: [-67.7, 11.2] }],
        legs: [{ a: [-70.8, -109.2], foot: 0, far: true }, { a: [-72, 142], foot: -114 }],
      },
      {
        label: 'Impulso do outro lado',
        hip: [50, 50], torso: 80, head: 6,
        arms: [{ a: [-91, -63], far: true }, { a: [-91, -63] }],
        legs: [{ a: [-104.2, -106.8], foot: -22, far: true }, { a: [-38, 26], foot: 126 }],
      },
      {
        label: 'E o outro pé larga o chão',
        hip: [50, 47], torso: 80, head: 6,
        arms: [{ a: [-67.7, 11.2], far: true }, { a: [-114.3, -137.2] }],
        legs: [{ a: [-130, -174], foot: -64, far: true }, { a: [-28, -74], foot: 16 }],
      },
    ],
  },
