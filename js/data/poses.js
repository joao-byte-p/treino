    ...
    frames: [
      {
        ...
        legs: [[-162.4, -156.4, 40, true], [-159.4, -159.4, 44]],
      },
      {
        label: 'Puxa o peito até à barra',
        hip: [45.6, 65], torso: 35.6, head: -6,
        arms: [{ pin: [66, 40], bend: -1, far: true }, { pin: [66, 40], bend: -1 }],
        legs: [[-147.4, -141.4, 40, true], [-144.4, -144.4, 44]],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        arms: ARMS_HANG,
        legs: [{ a: [-100, -125, -25], far: true }, { pin: [60, 88], foot: 0, bend: -1 }],
        items: [{ type: 'db', at: 'wrist0' }, { type: 'db', at: 'wrist1' }],
      },
      {
        ...
        arms: ARMS_HANG,
        legs: [{ a: [-118, -165, -15], far: true }, { pin: [60, 88], foot: 0, bend: -1 }],
        marks: [{ at: 'knee1' }],
        items: [{ type: 'db', at: 'wrist0' }, { type: 'db', at: 'wrist1' }],
      },
    ],
    ...
    frames: [
      {
        ...
        arms: ARMS_HANG,
        legs: [{ pin: [35, 76], foot: -20, bend: -1, far: true }, { pin: [64, 88], foot: 0, bend: -1 }],
        items: [{ type: 'db', at: 'wrist0' }, { type: 'db', at: 'wrist1' }],
      },
      {
    ...
    frames: [
      {
        ...
        hip: [50, 52], torso: 90, head: 0,
        arms: ARMS_HANG,
        legs: [{ a: [-92, -88, 4], far: true }, { pin: [50, 88], foot: 0, bend: -1 }],
        items: [{ type: 'db', at: 'wrist0' }, { type: 'db', at: 'wrist1' }],
      },
      {
        ...
        arms: ARMS_HANG,
        legs: [{ a: [-128, -142, -15], far: true }, { pin: [50, 88], foot: 0, bend: -1 }],
        marks: [{ at: 'knee1' }],
        items: [{ type: 'db', at: 'wrist0' }, { type: 'db', at: 'wrist1' }],
      },
    ],
    ...
    frames: [
      {
        ...
        arms: ARMS_HANG,
        legs: [{ a: [-124, -136, -15], far: true }, { pin: [62, 88], foot: 0, bend: -1 }],
        items: [{ type: 'db', at: 'wrist0' }, { type: 'db', at: 'wrist1' }],
      },
      {
        ...
        arms: ARMS_HANG,
        legs: [{ a: [-130, -170, -10], far: true }, { pin: [62, 88], foot: 0, bend: -1 }],
        marks: [{ at: 'knee1' }],
        items: [{ type: 'db', at: 'wrist0' }, { type: 'db', at: 'wrist1' }],
      },
    ],
    ...
    frames: [
      {
        ...
        legs: [{ a: [-88, -92, -10], far: true }, { pin: [56, 78], foot: 0, bend: -1 }],
      },
      {
  ...
  'tibialis-raise': {
    ...
    frames: [
      ...
      },
      {
        ...
        hip: [48, 56], torso: 90, head: 0,
        arms: [{ a: [-88, -86], far: true }, { a: [-86, -88] }],
        legs: [{ pin: [58, 88], foot: 44, bend: -1, far: true }, { pin: [58, 88], foot: 40, bend: -1 }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        hip: [50, 52], torso: 90, head: 0,
        arms: [{ a: [-93, -88], far: true }, { a: [-90, -90] }],
        legs: [{ a: [-96, -92, 4], far: true }, { pin: [50, 88], foot: 0, bend: -1 }],
        items: [{ type: 'db', at: 'wrist1' }],
      },
      {
        ...
        arms: [{ a: [-93, -88], far: true }, { a: [-90, -90] }],
        legs: [{ a: [172, 176, 190], far: true }, { pin: [50, 88], foot: 0, bend: -1 }],
        items: [{ type: 'db', at: 'wrist1' }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        legs: [{ pin: [10.6, 82], foot: -20, bend: 1, far: true }, { pin: [10.6, 85], foot: -18, bend: 1 }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        hip: [64, 80], torso: 160, head: -12,
        arms: [{ a: [147, 152], far: true }, { a: [150, 155] }],
        legs: [{ a: [7, 5, 44], far: true }, { a: [10, 8, 40] }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        hip: [62, 82], torso: 154, head: -14,
        arms: [{ a: [141, 146], far: true }, { a: [144, 149] }],
        legs: [{ a: [1, -1, 44], far: true }, { a: [4, 2, 40] }],
      },
      {
        label: 'Balança para a frente sem perder a forma',
        hip: [66, 78], torso: 166, head: -10,
        arms: [{ a: [153, 158], far: true }, { a: [156, 161] }],
        legs: [{ a: [13, 11, 44], far: true }, { a: [16, 14, 40] }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        legs: [{ a: [-150, -30, 0], far: true }, { pin: [64, 88], foot: 0, bend: -1 }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        legs: [{ a: [-56, -78, -10], far: true }, { pin: [50, 88], foot: 0, bend: -1 }],
      },
      {
        label: 'E para trás, amplitude progressiva',
        hip: [50, 52], torso: 90, head: 0,
        arms: [{ a: [-118, -8], far: true }, { a: [-115, -4] }],
        legs: [{ a: [-124, -104, -30], far: true }, { pin: [50, 88], foot: 0, bend: -1 }],
      },
    ],
  },
    ...
    frames: [
      {
        ...
        legs: [{ a: [-6, -96, -20], far: true }, { pin: [50, 88], foot: 0, bend: -1 }],
      },
      {
        label: 'Troca de perna',
        hip: [50, 52], torso: 88, head: 0,
        arms: [{ a: [-116, -66], far: true }, { a: [-64, -104] }],
        legs: [{ a: [-92, -88, -10], far: true }, { pin: [56, 62], foot: -30, bend: -1 }],
      },
    ],
  },
