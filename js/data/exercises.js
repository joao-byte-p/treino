...
export const EXERCISES = [
  ...
  {
    id: 'handstand-pushup-wall', name: 'Flexão em pino na parede', nameEn: 'Wall handstand push-up',
    pattern: 'push', chain: 'pike', level: 4, equipment: ['wall'], mode: 'reps',
    sets: 3, reps: [3, 6], rest: 120, knee: 'safe', load: false, homeAlt: 'pike-elevated',
    muscles: ['Ombros', 'Tríceps', 'Trapézio'],
    cues: ['Peito para a parede, corpo em linha', 'Desce a cabeça até dois dedos do chão', 'Sobe a empurrar o chão para longe'],
    mistakes: ['Arquear a lombar para compensar', 'Deixar os cotovelos abrirem para fora'],
    yt: 'wall handstand push up progression tutorial',
    ytId: 'gdhmNaZ7nAk', ytTitle: 'Andrew Alinda — Wall Handstand Push Ups | For WILD Shoulder Strength',
  },
  {
  ...
  {
    id: 'bar-dips-lsit', name: 'Dips com pernas à frente', nameEn: 'L-sit dips',
    pattern: 'push', chain: 'dips', level: 3, equipment: ['bars'], mode: 'reps',
    sets: 3, reps: [4, 8], rest: 90, knee: 'safe', load: false, homeAlt: 'chair-dips',
    muscles: ['Peito', 'Tríceps', 'Abdominais'],
    cues: ['Pernas esticadas à frente, à altura da anca', 'Desce até o ombro ficar ao nível do cotovelo', 'Mantém as pernas na linha durante toda a repetição'],
    mistakes: ['Dobrar os joelhos para aliviar', 'Perder a linha das pernas ao descer'],
    yt: 'l sit dips parallel bars tutorial',
    ytId: 'r-LQKNxGJB0', ytTitle: 'Gymless Fitness — L-Sit Tutorial On Floor, Bar And Parallel Bars (6 Step-by-Step Guide)',
  },
  {
  ...
  {
    id: 'db-curl-concentration', name: 'Curl concentrado', nameEn: 'Concentration curl',
    pattern: 'pull', chain: 'curl', level: 3, equipment: ['dumbbells', 'chair'], mode: 'reps',
    sets: 3, reps: [8, 12], rest: 60, tempo: '3s a descer', knee: 'safe', load: true, perSide: true,
    muscles: ['Bíceps', 'Braquial'],
    cues: ['Sentado, cotovelo na face interna da coxa', 'Sobe sem mexer o ombro', 'Desce em 3 segundos até esticar o braço'],
    mistakes: ['Balançar o tronco para ajudar', 'Tirar o cotovelo da coxa no fim'],
    yt: 'concentration curl proper form technique',
    ytId: 'Jvj2wV0vOYU', ytTitle: 'ScottHermanFitness — How To: Dumbbell Concentration Curl',
  },
  {
  ...
  {
    id: 'pistol-full', name: 'Pistol squat completo', nameEn: 'Pistol squat',
    pattern: 'squat', chain: 'squat', level: 5, equipment: ['body'], mode: 'reps',
    sets: 3, reps: [3, 6], rest: 120, tempo: '3s a descer', knee: 'care', load: false, perSide: true,
    muscles: ['Quadríceps', 'Glúteo', 'Equilíbrio'],
    cues: ['Perna livre estendida à frente', 'Desce em 3 segundos, joelho alinhado com o pé', 'Sobe sem impulso, a apertar o glúteo'],
    mistakes: ['Joelho a cair para dentro', 'Largar o controlo nos últimos centímetros'],
    yt: 'pistol squat full tutorial progression',
    ytId: 'hHxm3VbuS-w', ytTitle: 'School of Calisthenics — How To PISTOL SQUAT [Full Progressions] // School of Calisthenics',
  },
  {
  ...
  {
    id: 'wall-sit-single', name: 'Wall sit numa perna', nameEn: 'Single-leg wall sit',
    pattern: 'knee', chain: 'kneeiso', level: 3, equipment: ['wall'], mode: 'time',
    sets: 3, time: 25, rest: 45, knee: 'care', load: false, perSide: true,
    muscles: ['Quadríceps', 'Glúteo', 'Tendão patelar'],
    cues: ['Costas na parede, joelho de apoio a 90°', 'A outra perna estica à frente', 'Joelho alinhado com o pé, sem cair para dentro'],
    mistakes: ['Anca a rodar para o lado da perna livre', 'Passar dos 90° antes de aguentar os 25 segundos'],
    yt: 'single leg wall sit exercise how to',
    ytId: '01uSdj_zz08', ytTitle: 'The Strength Guys — Single Leg Wall Sit Isometric',
  },
  {
  ...
  {
    id: 'hip-thrust-single-elevated', name: 'Hip thrust unilateral com pé elevado', nameEn: 'Elevated single-leg hip thrust',
    pattern: 'glute', chain: 'thrust', level: 4, equipment: ['dumbbells', 'chair'], mode: 'reps',
    sets: 3, reps: [8, 12], rest: 75, knee: 'safe', load: true, perSide: true,
    muscles: ['Glúteo', 'Isquiotibiais'],
    cues: ['Ombros no banco e pé de apoio num degrau', 'Anca sobe nivelada, sem rodar', 'Aperta o glúteo um segundo em cima'],
    mistakes: ['Empurrar com a lombar em vez do glúteo', 'Deixar a anca cair de um lado'],
    yt: 'elevated single leg hip thrust form',
    ytId: 'YIpw8ogCVKs', ytTitle: 'Bret Contreras Glute Guy — Shoulder and Feet Elevated Hip Thrusts and Single Leg Hip Thrusts',
  },
  {
  ...
  {
    id: 'side-plank-dips', name: 'Prancha lateral com subida da anca', nameEn: 'Side plank hip dips',
    pattern: 'core', chain: 'sideplank', level: 3, equipment: ['body'], mode: 'reps',
    sets: 3, reps: [8, 12], rest: 30, knee: 'safe', load: false, perSide: true,
    muscles: ['Oblíquos', 'Glúteo médio'],
    cues: ['Começa na prancha lateral com a anca alta', 'Desce a anca a dois dedos do chão', 'Sobe apertando o oblíquo de baixo'],
    mistakes: ['Rodar o tronco para a frente', 'Deixar a anca chegar ao chão'],
    yt: 'side plank hip dips proper form',
    ytId: 'hAAJ7EsluLY', ytTitle: 'Lean Physique Lab — How to do Side Plank Dips the correct way (Perfect Technique) | Tutorial',
  },
  {
