...
globalThis.fetch = async (url, opts = {}) => {
  ...
  if (u.includes('grant_type=refresh_token')) return resp(200, { access_token: 'tok2', refresh_token: 'ref2', expires_in: 3600, user: { email: 'treino@exemplo.pt' } });
